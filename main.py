from flask import Flask, abort, render_template, Response, send_file
...
def generate_and_send():
    convert("upload.pdf")
    #print("File is going to be sendt!")
#
    #return send_file("upload.pdf") 
    return send_file("upload.pdf", as_attachment =True, download_name="upload.pdf")